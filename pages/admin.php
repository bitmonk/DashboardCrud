...
<body class="g-sidenav-show bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="profile.php" target="_blank">
                ...
                if(in_array($imageOgExt, $allowed)){
                  ...
                  if($image_error === 0){
                    if($image_size < 5000000){
                      ...
                      // $imgae_destination = 
                      if(move_uploaded_file($_FILES['image']['tmp_name'],'uploads/'.$image_new_name)){
                        $update_image = "UPDATE users SET image = '$image_new_name' WHERE id = '$sessionid'";
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="./uploads/<?php if($result['image'] == null){echo "profile.png" ;}else{echo $result['image'];}  ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
            ...
            <form action="profile.php" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div>
                    <label class="form-label" for="customFile">Change Image<?php if(isset($imageError)){echo $imageError;} ?></label>
